...
return [
    ...
    Route::get('/admin/actors/add', [ActorController::class, 'create']),
    Route::post('/admin/actors/add', [ActorController::class, 'store']),
    Route::post('/admin/actors/destroy', [ActorController::class, 'destroy']),
    Route::get('/admin/actors/update', [ActorController::class, 'edit']),
    Route::post('/admin/actors/update', [ActorController::class, 'update']),
